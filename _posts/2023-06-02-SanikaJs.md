...
<body>
  ...
  <script>
    ...
    function songCheck() {
      const artistl = document.getElementById('artist').value.toLowerCase();
      const songl = document.getElementById('song').value.toLowerCase();
      ...
      for (let i = 0; i < rows.length; i++) {
        ...
        if (songName.includes(songl) && artistName.includes(artistl)) {
          ...
          document.getElementById('out').textContent = 'This song contains the artist you are looking for!';
          return;
        }
      }

      console.log('Song is not in our playlist. Check spelling or enter a different song.');
      document.getElementById('out').textContent = 'Song is not in our playlist. Check spelling or enter a different song.';
    }
  </script>
</body>
</html>
